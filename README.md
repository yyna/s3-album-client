...
* [`src/client/styles.cljs`](src/client/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/client/`](src/client/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/client/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `client` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/client/config.cljs) defaults to `true` in
...
```clj
(ns client.example
  (:require [client.config :as config])
